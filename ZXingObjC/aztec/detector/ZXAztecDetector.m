 ...
 * 
 * @return {@link ZXAztecDetectorResult} encapsulating results of detecting an Aztec Code
...
- (NSArray*)matrixCornerPoints:(NSArray*)bullEyeCornerPoints {
  ...
  return [NSArray arrayWithObjects:[[[ZXResultPoint alloc] initWithX:targetax y:targetay] autorelease],
...
- (ZXAztecPoint *)matrixCenter {
  ...
  @try {
    NSArray * cornerPoints = [[[[ZXWhiteRectangleDetector alloc] initWithImage:image] autorelease] detect];
  ...
  @try {
    NSArray * cornerPoints = [[[[ZXWhiteRectangleDetector alloc] initWithImage:image initSize:15 x:cx y:cy] autorelease] detect];
    pointA = [cornerPoints objectAtIndex:0];
    pointB = [cornerPoints objectAtIndex:1];
    pointC = [cornerPoints objectAtIndex:2];
    pointD = [cornerPoints objectAtIndex:3];
