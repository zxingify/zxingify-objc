...
+ (PerspectiveTransform *) squareToQuadrilateral:(float)x0 y0:(float)y0 x1:(float)x1 y1:(float)y1 x2:(float)x2 y2:(float)y2 x3:(float)x3 y3:(float)y3 {
  ...
  if (dy2 == 0.0f && dy3 == 0.0f) {
    return [[[PerspectiveTransform alloc] init:x1 - x0 a21:x2 - x1 a31:x0 a12:y1 - y0 a22:y2 - y1 a32:y0 a13:0.0f a23:0.0f a33:1.0f] autorelease];
  }
   else {
    float dx1 = x1 - x2;
    float dx2 = x3 - x2;
    ...
    return [[[PerspectiveTransform alloc] init:x1 - x0 + a13 * x1 a21:x3 - x0 + a23 * x3 a31:x0 a12:y1 - y0 + a13 * y1 a22:y3 - y0 + a23 * y3 a32:y0 a13:a13 a23:a23 a33:1.0f] autorelease];
  }
}
...
- (PerspectiveTransform *) buildAdjoint {
  return [[[PerspectiveTransform alloc] init:a22 * a33 - a23 * a32 a21:a23 * a31 - a21 * a33 a31:a21 * a32 - a22 * a31 a12:a13 * a32 - a12 * a33 a22:a11 * a33 - a13 * a31 a32:a12 * a31 - a11 * a32 a13:a12 * a23 - a13 * a22 a23:a13 * a21 - a11 * a23 a33:a11 * a22 - a12 * a21] autorelease];
}

- (PerspectiveTransform *) times:(PerspectiveTransform *)other {
  return [[[PerspectiveTransform alloc] init:a11 * other->a11 + a21 * other->a12 + a31 * other->a13 a21:a11 * other->a21 + a21 * other->a22 + a31 * other->a23 a31:a11 * other->a31 + a21 * other->a32 + a31 * other->a33 a12:a12 * other->a11 + a22 * other->a12 + a32 * other->a13 a22:a12 * other->a21 + a22 * other->a22 + a32 * other->a23 a32:a12 * other->a31 + a22 * other->a32 + a32 * other->a33 a13:a13 * other->a11 + a23 * other->a12 + a33 * other->a13 a23:a13 * other->a21 + a23 * other->a22 + a33 * other->a23 a33:a13 * other->a31 + a23 * other->a32 + a33 * other->a33] autorelease];
}
