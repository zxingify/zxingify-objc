...
- (void)testASCIIEncodation {
  ...
  XCTAssertEqualObjects(visualized, @"142 164 186", @"");

  visualized = [self encodeHighLevel:@"123456£"];
  XCTAssertEqualObjects(visualized, @"142 164 186 235 36", @"");

  visualized = [self encodeHighLevel:@"30Q324343430794<OQQ"];
  XCTAssertEqualObjects(visualized, @"160 82 162 173 173 173 137 224 61 80 82 82", @"");
}

- (void)testC40EncodationBasic1 {
  NSString *visualized = [self encodeHighLevel:@"AIMAIMAIM"];
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 254", @"");
...
- (void)testC40EncodationBasic2 {
  ...
  XCTAssertEqualObjects(visualized, @"230 91 11 90 255 254 67 129", @"");
  ...
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 254 235 76", @"");
  //Alternative solution:
  ...
  visualized = [self encodeHighLevel:@"AIMAIMAIMë"];
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 254 235 108", @""); //Activate when additional rectangulars are available
  //Expl: 230 = shift to C40, "91 11" = "AIM",
...
- (void)testC40EncodationSpecExample {
  ...
  XCTAssertEqualObjects(visualized, @"230 88 88 40 8 107 147 59 67 126 206 78 126 144 121 35 47 254", @"");
}
...
- (void)testC40EncodationSpecialCases1 {
  ...
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 91 11 91 11 91 11", @"");
  //case "a": Unlatch is not required

  visualized = [self encodeHighLevel:@"AIMAIMAIMAIMAIMAI"];
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 91 11 91 11 90 241", @"");
  //case "b": Add trailing shift 0 and Unlatch is not required

  visualized = [self encodeHighLevel:@"AIMAIMAIMAIMAIMA"];
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 91 11 91 11 254 66", @"");
  //case "c": Unlatch and write last character in ASCII

  [self resetSymbols];

  visualized = [self encodeHighLevel:@"AIMAIMAIMAIMAIMAI"];
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 91 11 91 11 254 66 74 129 237", @"");

  visualized = [self encodeHighLevel:@"AIMAIMAIMA"];
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 66", @"");
...
- (void)testC40EncodationSpecialCases2 {
  ...
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 91 11 91 11 91 11 254 66 74", @"");
  //available > 2, rest = 2 --> unlatch and encode as ASCII
}

- (void)testTextEncodation {
  NSString *visualized = [self encodeHighLevel:@"aimaimaim"];
  XCTAssertEqualObjects(visualized, @"239 91 11 91 11 91 11 254", @"");
  //239 shifts to Text encodation, 254 unlatches

  visualized = [self encodeHighLevel:@"aimaimaim'"];
  XCTAssertEqualObjects(visualized, @"239 91 11 91 11 91 11 254 40 129", @"");
  ...
  visualized = [self encodeHighLevel:@"aimaimaIm"];
  XCTAssertEqualObjects(visualized, @"239 91 11 91 11 87 218 110", @"");
...
- (void)testX12Encodation {
  ...
  XCTAssertEqualObjects(visualized, @"238 89 233 14 192 100 207 44 31 67", @"");

  visualized = [self encodeHighLevel:@"ABC>ABC123>ABC"];
  XCTAssertEqualObjects(visualized, @"238 89 233 14 192 100 207 44 31 254 67 68", @"");

  visualized = [self encodeHighLevel:@"ABC>ABC123>ABCD"];
  XCTAssertEqualObjects(visualized, @"238 89 233 14 192 100 207 44 31 96 82 254", @"");

  visualized = [self encodeHighLevel:@"ABC>ABC123>ABCDE"];
  XCTAssertEqualObjects(visualized, @"238 89 233 14 192 100 207 44 31 96 82 70", @"");

  visualized = [self encodeHighLevel:@"ABC>ABC123>ABCDEF"];
  XCTAssertEqualObjects(visualized, @"238 89 233 14 192 100 207 44 31 96 82 254 70 71 129 237", @"");
}
...
- (void)testEDIFACTEncodation {
  ...
  XCTAssertEqualObjects(visualized, @"240 184 27 131 198 236 238 16 21 1 187 28 179 16 21 1 187 28 179 16 21 1", @"");

  visualized = [self encodeHighLevel:@".A.C1.3.X.X2.."];
  XCTAssertEqualObjects(visualized, @"240 184 27 131 198 236 238 98 230 50 47 47", @"");

  visualized = [self encodeHighLevel:@".A.C1.3.X.X2."];
  XCTAssertEqualObjects(visualized, @"240 184 27 131 198 236 238 98 230 50 47 129", @"");

  visualized = [self encodeHighLevel:@".A.C1.3.X.X2"];
  XCTAssertEqualObjects(visualized, @"240 184 27 131 198 236 238 98 230 50", @"");

  visualized = [self encodeHighLevel:@".A.C1.3.X.X"];
  XCTAssertEqualObjects(visualized, @"240 184 27 131 198 236 238 98 230 31", @"");

  visualized = [self encodeHighLevel:@".A.C1.3.X."];
  XCTAssertEqualObjects(visualized, @"240 184 27 131 198 236 238 98 231 192", @"");

  visualized = [self encodeHighLevel:@".A.C1.3.X"];
  XCTAssertEqualObjects(visualized, @"240 184 27 131 198 236 238 89", @"");
  ...
  XCTAssertEqualObjects(visualized, @"240 185 134 24 185 134 24 185 134 24 185 134 24 185 134 24 185 134 24"
...
- (void)testBase256Encodation {
  ...
  XCTAssertEqualObjects(visualized, @"231 44 108 59 226 126 1 104", @"");
  visualized = [self encodeHighLevel:@"\u00ABäöüéà\u00BB"];
  XCTAssertEqualObjects(visualized, @"231 51 108 59 226 126 1 141 254 129", @"");
  visualized = [self encodeHighLevel:@"\u00ABäöüéàá\u00BB"];
  XCTAssertEqualObjects(visualized, @"231 44 108 59 226 126 1 141 36 147", @"");

  visualized = [self encodeHighLevel:@" 23£"]; //ASCII only (for reference)
  XCTAssertEqualObjects(visualized, @"33 153 235 36 129", @"");

  visualized = [self encodeHighLevel:@"\u00ABäöüé\u00BB 234"]; //Mixed Base256 + ASCII
  XCTAssertEqualObjects(visualized, @"231 51 108 59 226 126 1 104 99 153 53 129", @"");

  visualized = [self encodeHighLevel:@"\u00ABäöüé\u00BB 23£ 1234567890123456789"];
  XCTAssertEqualObjects(visualized, @"231 55 108 59 226 126 1 104 99 10 161 167 185 142 164 186 208"
               @" 220 142 164 186 208 58 129 59 209 104 254 150 45", @"");

  visualized = [self encodeHighLevel:[self createBinaryMessage:20]];
  XCTAssertEqualObjects(visualized, @"231 44 108 59 226 126 1 141 36 5 37 187 80 230 123 17 166 60 210 103 253 150", @"");
  visualized = [self encodeHighLevel:[self createBinaryMessage:19]]; //padding necessary at the end
  XCTAssertEqualObjects(visualized, @"231 63 108 59 226 126 1 141 36 5 37 187 80 230 123 17 166 60 210 103 1 129", @"");
...
- (void)testUnlatchingFromC40 {
  ...
  XCTAssertEqualObjects(visualized, @"230 91 11 91 11 91 11 254 66 74 78 239 91 11 91 11 91 11", @"");
}

- (void)testUnlatchingFromText {
  NSString *visualized = [self encodeHighLevel:@"aimaimaimaim12345678"];
  XCTAssertEqualObjects(visualized, @"239 91 11 91 11 91 11 91 11 254 142 164 186 208 129 237", @"");
}

- (void)testHelloWorld {
  NSString *visualized = [self encodeHighLevel:@"Hello World!"];
  XCTAssertEqualObjects(visualized, @"73 239 116 130 175 123 148 64 158 233 254 34", @"");
}
...
- (void)testBug1664266 {
  ...
  XCTAssertEqualObjects(visualized, @"240 13 33 88 181 64 78 124 59 105", @"");

  visualized = [self encodeHighLevel:@"CREX-TAN:hh"];
  XCTAssertEqualObjects(visualized, @"240 13 33 88 181 64 78 124 59 105 105 129", @"");

  visualized = [self encodeHighLevel:@"CREX-TAN:hhh"];
  XCTAssertEqualObjects(visualized, @"240 13 33 88 181 64 78 124 59 105 105 105", @"");
}
...
- (void)testBug3048549 {
  ...
  XCTAssertEqualObjects(visualized, @"239 122 87 154 40 7 171 115 207 12 130 71 155 254 129 237", @"");
}
...
- (void)testMacroCharacters {
  ...
  XCTAssertEqualObjects(visualized, @"236 185 185 29 196 196 129 56", @"");
}
